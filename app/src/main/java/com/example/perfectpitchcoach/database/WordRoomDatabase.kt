...
import com.example.perfectpitchcoach.database.databaseAccessObject_DAO.WordDao
...
import com.example.perfectpitchcoach.database.model.SubPractices
 ...
 */
@Database(entities = [Word::class, MasterClass::class, SubMasterClass::class, SubPractices::class], version = 11 )
abstract class WordRoomDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun populateDatabase(wordDao: WordDao) {
            ...
            /* var word = Word("Hello")
            wordDao.insertMasterClasses(word)
            word = Word("World!")
            wordDao.insertMasterClasses(word) */
        }
    }
